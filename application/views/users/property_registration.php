					...
					<div class="inner-body">
						...
						<div class="page-header">
							<div class="headertext">
								<h2 class="main-content-title tx-24 mg-b-5">Add Properties</h2>
									...
									<div class="card-body">
										 <form class="form-horizontal" action="/action_page.php">
											  <div class="form-group">
											    <label class="control-label col-sm-2" for="email">Porperty Name</label>
											    <div class="col-sm-10">
											  ...
											  <div class="form-group">
											    ...
											    <div class="col-sm-10">
											    	<select name="" id="" class="form-control">
											    		<option>- - Select Prooerty Type - - </option>
											    		 <?php 
                                                        	foreach ($transaction_type as $key=>$val){
                                                    	  ?>
                                                    	  <option value="<?php echo $val->id; ?>"><?php echo $val->transaction_name_en; ?></option>
                                                    	  <?php 
                                                    	  	}
                                                    	  ?>
											    	 </select>
