...
<div class="header-image-wrapper">
	...
	<div class="header-image-content">
	    <h1 class="title" style=" text-align: center;">dealer registration</h1>
            ...
            <div class="beatle-container">  
                <div class="row center-xs middle-xs my-5"> 
					 ...
					 <div class="mdc-tab-bar-wrapper submit-property"> 
						...
						<div class="col-xs-12 col-sm-12 p-2 profile_upoad">
						   <div class="small-12 medium-2 large-2 columns">
						     <div class="circle">
						       <!-- User Profile Image -->
						       <img class="profile-pic" src="<?php echo ASSETS_URL;?>assets/images/agents/a-2.jpg">
                    ...
                    <div class="text-center mt-5"> 
                        <a href="dealer-registration-submit.html" class="mdc-button mdc-button--raised mdc-button mdc-button--raised cust_btn _bg_blu mdc-ripple-upgraded" type="submit">
