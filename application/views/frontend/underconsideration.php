            ...
            <div class="beatle-container-- row between-xs middle-xs h-100">   
                                 ...
                                 <table id="investor-match-property" class="display nowrap" style="width:100%">
                                   <thead>
                                        <tr class="mdc-data-table__header-row">
										    ...
										    <th class="mdc-data-table__header-cell"> Estimate Percentage</th> 
                                    ...
                                    <tbody class="mdc-data-table__content s">
                                       <?php 
                                       		if (!empty($getcondirationpro)){
                                       			foreach ($getcondirationpro as $key=>$val){
				...
				$percetage = 	($val->property_estimated_return/100)*$val->property_investment_amount;
                                      ...
                                      <tr class="mdc-data-table__row">
                                            ...
                                            <td class="mdc-data-table__cell"><a href="<?php echo SITE_URL?>investorproperty/<?php echo base64_encode($val->property_id); ?>" class="mdc-button mdc-ripple-surface mdc-ripple-surface--primary normal mdc-ripple-upgraded"><?php echo $val->property_name; ?></a></td>
											...
											<td class="mdc-data-table__cell"><?php echo $percetage; ?> $</td>
