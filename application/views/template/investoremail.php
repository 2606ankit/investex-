	                                  ...
	                                  <tr>
	                                    <td class="grey-block" style="/* margin-bottom: 52px; */border-collapse: collapse;border: 0;margin: 0;padding: 18px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;background-color: #f6f6f6;border-top: 3px solid #00a5b5;border-left: 1px solid #E6E6E6;border-right: 1px solid #E6E6E6;border-bottom: 1px solid #E6E6E6;width: 250px;text-align: left;padding: 15px !important;">
	                                      <span style="
	                                                   ...
	                                                   text-align: center;
	                                                   font-weight: bold;
	                                                   "><?php echo $v['property_name']; ?>
	                                      </span>
	                                      <br>
	                                      <p class="row address flex-nowrap" style="
                                                                                  margin: 7px 0 0 0;
                                                                                  ">
                                          <i class="material-icons text-muted">Detail : 
                                          </i>
                                          <span> <?php echo $v['property_details'];?>
                                          </span>
                                        </p>
                                         <p class="row address flex-nowrap" style="
                                                                                  margin: 7px 0 0 0;
                                                                                  ">
                                          <span> <?php $proimag = explode('|',$v['property_image']);?>
                                          <img src="<?php echo FRONTEND_URL;?>property_image/<?php echo $proimag[0];?>" style="width:500px; border:1px solid #ddd; border-radius:4px; padding:5px;">
                                          </span>
                                        </p>
                                         <p class="row address flex-nowrap" style="
	                                                                                margin: 7px 0 0 0;
	                                      ...
	                                      <p class="row address flex-nowrap" style="
	                                                                                margin: 0;
	                                                                                ">
	                                        <i class="material-icons text-muted">Prpoerty Price : 
	                                        </i>
	                                        <span>$ <?php echo $v['property_price']; ?> 
	                                        </span>
	                                      </p>
	                                      <p class="row address flex-nowrap" style="
	                                                                                margin: 0 0 17px 0px;
	                                        ...
	                                        <span>
	                                          <b>$ <?php echo $v['property_investment_amount']; ?>
	                                          </b>
	                                        </span> 
	                                      </p>
                                        <p class="row address flex-nowrap" style="
                                                                                  margin: 0 0 17px 0px;
                                                                                  ">
                                          <i class="material-icons text-muted">Estimate Return  : 
                                          </i>
                                          <span>
                                            <b>$ <?php echo $v['property_estimated_return']; ?>
                                            </b>
                                          </span> 
                                        </p>
